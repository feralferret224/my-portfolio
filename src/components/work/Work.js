    ...
    <div id="Work">
      <div className="container">
        ...
        <div className='intro row justify-content-between'>
          ...
          <p>This means that I'm interested in solving problems using cloud technologies. Researching and becoming familiar with the cloud has been an extremely rewarding journey. My clientele is public sector.</p>
